# AGENTS.md — `oss96/element-web` fork

Project-specific context for Codex sessions working on this fork. Upstream
...
flipped — update **both** `AGENTS.md` and `FORK_CHANGES.md` in the same
...
- `AGENTS.md` (this file) — agent-facing working brief: what to know to
